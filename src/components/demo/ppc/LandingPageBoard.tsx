...
export function LandingPageBoard({ onCreateNew, onEditPage, pages, onPagesChange }: LandingPageBoardProps) {
  ...
  const getPerformanceStyles = (perf: LandingPage['performance']) => {
    switch (perf) {
      case 'excellent': return { bg: 'bg-emerald-500/10', text: 'text-emerald-600', border: 'border-emerald-500/30' };
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 py-2 border-y border-border">
                    ...
                    <div>
                      ...
                      <p className={`font-semibold ${page.cpa < 15 ? 'text-emerald-600' : page.cpa > 20 ? 'text-red-500' : 'text-foreground'}`}>
                        ${page.cpa.toFixed(2)}
                      </p>
                    </div>
                  </div>

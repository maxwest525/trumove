       ...
       <div className="flex items-center gap-2 flex-wrap">
         ...
         {QUICK_PROMPTS.map((qp) => (
           <button
             ...
             disabled={isProcessing}
             className="px-3 py-1.5 rounded-full text-xs font-medium border border-border bg-background hover:border-primary hover:text-primary transition-colors flex items-center gap-1 group"
           >
             {qp.label}

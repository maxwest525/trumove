  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Unified secondary outline: subtle border, NO green text on hover, just border/glow accent
        outline: "border border-border bg-transparent text-foreground hover:border-primary/50 hover:shadow-[0_0_12px_hsl(var(--primary)/0.15)] hover:bg-transparent",
        secondary: "border border-border bg-muted/50 text-foreground hover:border-primary/50 hover:shadow-[0_0_12px_hsl(var(--primary)/0.15)] hover:bg-muted/60",
        ghost: "hover:bg-accent/50 hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        // Premium dark button with green glow

        ...
        {!wizardComplete ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 items-start">
            ...
            <div className="space-y-6">
              ...
              {/* Inventory List with Thumbnails - Now under the builder */}
              {items.length > 0 && (
                    ...
                    <div className="space-y-1.5">
                      {items.map((item) => (
                        ...
                        >
                          ...
                          <span className="text-xs text-muted-foreground tabular-nums">
                            {item.weightEach * item.quantity} lbs
                          </span>
                        </div>
                      ))}
                    </div>
              ...
              {/* Inventory Table - Full width below list */}
              {items.length > 0 && (
                <InventoryTable 
                  items={items}
            ...
            {/* Right Column - Summary (room counts) + Finalize */}
            <div className="space-y-4 lg:sticky lg:top-6">
              {/* Move Summary - Shows items per room */}

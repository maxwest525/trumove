      ...
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        {!wizardComplete ? (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,640px)_220px_1fr] gap-6 lg:items-start">
              {/* Left - Wizard (sized like homepage form) */}
              <div className="tru-floating-form-card lg:max-w-none">

...
import { Lock, Package, Truck, ShieldCheck, Sparkles, Calculator, Clock, BadgeCheck } from "lucide-react";
...
Generated by TruMove Online Estimate Tool
  ...
  return (
    <SiteShell>
      {/* Dashboard Header - Matches Shipment Command Center & Contact Center */}
      <header className="estimate-header">
        ...
        <div className="estimate-header-trust">
          <span className="estimate-header-trust-item">
            <Sparkles className="w-3.5 h-3.5 text-primary" />
            AI POWERED
          </span>
          <span className="estimate-header-trust-dot">•</span>
          <span className="estimate-header-trust-item">
      ...
      <div className="max-w-[1440px] mx-auto pl-4 pr-4 py-8">

...
Generated by TruMove Online Estimate Tool
  ...
  return (
    <SiteShell>
        ...
        {!wizardComplete ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6 items-start">
            ...
            <div className="space-y-6">
              <div ref={inventoryRef} className="rounded-2xl border border-border/60 bg-card p-5 shadow-lg animate-fade-in">
                <div className="flex items-center gap-2 mb-4">
            ...
            {/* Right Column - Summary + Finalize (removed CompactInventoryList) */}
      ...
      {/* Floating Inventory Button (only when unlocked) */}
      {wizardComplete && (

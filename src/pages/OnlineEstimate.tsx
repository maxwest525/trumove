      ...
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        {!wizardComplete ? (
          <div className="space-y-6">
            {/* Row 1: Wizard + Quote Snapshot (height matched) */}
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6 lg:items-stretch">
              {/* Left - Wizard */}
              <div className="tru-estimate-wizard-container lg:max-w-none">
                <EstimateWizard onComplete={handleWizardComplete} />
              </div>
              
              {/* Right - Quote Snapshot */}

  ...
  return (
    <SiteShell>
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        {/* Conditional Layout: 2-column when locked (Form+Summary | Full-width Inventory), 2-column when unlocked */}
        {!wizardComplete ? (
          // LOCKED STATE: Two-Column Layout - Form+Summary (left) | Inventory (full remaining width)
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6 items-start">
            {/* Left Column - Wizard + Summary stacked */}
            ...
            {/* Right Column - Inventory Builder (locked, takes full remaining width) */}
            <div className="relative w-full">
              ...
              <div className="rounded-2xl border border-border/60 bg-card p-5 shadow-lg tru-inventory-locked w-full">

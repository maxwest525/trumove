...
import { Package, Route, Calculator } from "lucide-react";
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        {!wizardComplete ? (
          <div className="space-y-6">
            {/* Row 1: Wizard + Vertical Summary Sidebar */}
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 lg:items-stretch">
              {/* Left - Wizard */}
              <div className="tru-estimate-wizard-container lg:max-w-none">
                <EstimateWizard onComplete={handleWizardComplete} />
              </div>
              
              {/* Right - Vertical Summary (like homepage) */}
              <div className="tru-hero-sidebar-top hidden lg:flex" style={{ height: '400px' }}>
                <QuoteSnapshotVertical items={items} moveDetails={moveDetails} />
              </div>
            </div>
            
            {/* Row 2: Feature Previews (below both cards) */}
            <div className="tru-feature-section max-w-[700px]">
              <p className="tru-feature-section-label">Complete the form to unlock:</p>
              <div className="tru-feature-previews-row">
                <button 
                  type="button"
                  className="tru-feature-card"
                  onClick={() => document.querySelector('.tru-estimate-wizard')?.scrollIntoView({ behavior: 'smooth' })}
                >
                  <div className="tru-feature-card-icon">
                    <Package className="w-5 h-5" />
                  </div>
                  <div className="tru-feature-card-info">
                    <span className="tru-feature-card-title">Smart Inventory</span>
                    <span className="tru-feature-card-desc">Add items room-by-room</span>
                  </div>
                </button>
                <button 
                  type="button"
                ...
                >
                  ...
                  <div className="tru-feature-card-info">
                    <span className="tru-feature-card-title">Route Preview</span>
                    <span className="tru-feature-card-desc">See your move distance</span>
                  </div>
                </button>
                <button 
                  type="button"
                ...
                >
                  ...
                  <div className="tru-feature-card-info">
                    <span className="tru-feature-card-title">Live Estimate</span>
                    <span className="tru-feature-card-desc">Real-time price updates</span>
                  </div>
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6">
            ...
            <div className="tru-hero-sidebar-top lg:sticky lg:top-[100px] hidden lg:flex" style={{ height: '500px' }}>
              <QuoteSnapshotVertical items={items} moveDetails={moveDetails} />
            </div>
          </div>
        )}

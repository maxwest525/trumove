...
Generated by TruMove Online Estimate Tool
  ...
  return (
    <SiteShell>
      <div className="max-w-[1400px] mx-auto pl-8 pr-4 py-8">
        {/* Compact Hero */}
        ...
        {!wizardComplete ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[480px_1fr_240px] gap-4 items-start">
            {/* Left Column - Wizard */}
            <div className="space-y-4">
              {/* Start Building Pill - At top of form when inventory empty */}
              {items.length === 0 && (
                <div className="flex items-center justify-center gap-2 px-4 py-3 rounded-full border border-slate-300 bg-slate-50 text-sm font-semibold text-slate-700">
                  <Package className="w-4 h-4" />
                  Start building your inventory after completing this form
                </div>
              )}

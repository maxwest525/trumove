        ...
        {!wizardComplete ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6 items-start">
            ...
            <div className="space-y-6">
              {/* Inventory Builder with pill header */}
              <div ref={inventoryRef} className="tru-move-summary-card is-expanded">
                ...
                <div className="tru-qb-form-header tru-qb-form-header-pill tru-qb-form-header-summary">
                  ...
                  <div className="tru-qb-form-title-group">
                    ...
                    <span className="tru-qb-form-subtitle-compact">ADD ITEMS OR SCAN YOUR ROOMS</span>
                  </div>
                </div>

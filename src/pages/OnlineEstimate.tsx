      ...
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6">
          ...
          <div className="space-y-6">
            {!wizardComplete ? (
              /* Wizard with actual inventory builder visible in background */
              <div className="tru-estimate-overlay">
                ...
                {/* Actual Inventory Builder visible in background */}
                <div className="tru-estimate-bg-inventory">
                  <div className="tru-estimate-bg-inventory-inner">
                  ...
                  <div className="tru-estimate-lock-overlay">
                    <div className="tru-estimate-lock-message">
                      <Lock className="w-4 h-4" />
                      <span>Complete the wizard above to start building your inventory</span>
                    </div>
                  </div>
                </div>
              </div>

  ...
  return (
    <SiteShell>
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        {!wizardComplete ? (
          // LOCKED STATE: Centered large form with summary on right
          <div className="flex justify-center items-start gap-6">
            {/* Center - Large Wizard Form */}
            ...
            {/* Right - Floating Summary Pill */}
            <div className="hidden lg:block lg:sticky lg:top-6 flex-shrink-0">

  ...
  return (
    <SiteShell>
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        {!wizardComplete ? (
          // LOCKED STATE: Two-Column Layout - Large Form | Large Locked Inventory + Summary
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            {/* Left Column - Large Wizard Form */}
            ...
            {/* Right Column - Large Locked Inventory + Summary */}
            <div className="space-y-4">
              {/* Locked Inventory Preview */}
              <div className="relative">
                ...
                <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-lg tru-inventory-locked min-h-[400px]">
                  <div className="flex items-center gap-2 mb-4">
                    <span className="w-8 h-8 rounded-full border-2 border-muted-foreground/30 bg-muted/30 text-muted-foreground/50 text-base font-bold flex items-center justify-center">2</span>
                    <h2 className="text-xl font-black text-muted-foreground/50">Build your inventory</h2>
                  </div>
                  <InventoryBuilder 

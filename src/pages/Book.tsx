        ...
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr,380px] gap-4 mb-8">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              {/* Quick Tools - Matching ContactHub style with hover glow */}
              {!roomUrl && (
                <div className="flex items-center justify-center gap-4">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className="group flex items-center gap-2.5 px-5 py-3 rounded-xl bg-slate-800/50 border-2 border-slate-600 hover:border-slate-400 hover:bg-slate-700/60 hover:shadow-lg hover:shadow-emerald-500/10 hover:scale-[1.02] active:scale-100 transition-all duration-200"
                      >
                        <div className="w-9 h-9 rounded-lg bg-slate-950 border border-slate-700 flex items-center justify-center group-hover:bg-slate-900 transition-all duration-200">
                          <CalendarDays className="w-4 h-4 text-emerald-400" strokeWidth={2} />
                        </div>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <div className="w-9 h-9 rounded-lg bg-slate-950 border border-slate-700 flex items-center justify-center group-hover:bg-slate-900 transition-all duration-200">
                          <PenTool className="w-4 h-4 text-emerald-400" strokeWidth={2} />
                        </div>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <div className="w-9 h-9 rounded-lg bg-slate-950 border border-slate-700 flex items-center justify-center group-hover:bg-slate-900 transition-all duration-200">
                          <Monitor className="w-4 h-4 text-emerald-400" strokeWidth={2} />
                        </div>

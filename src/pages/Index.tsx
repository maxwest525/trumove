                      ...
                      {fromCoords && toCoords && (
                        <>
                          ...
                          <img 
                            ...
                            onLoad={(e) => e.currentTarget.classList.add('is-loaded')}
                          />
                          {/* Route overlay - revealed progressively with clip-path */}
                          {routeGeometry && (
                            <img 
                              src={`https://api.mapbox.com/styles/v1/mapbox/streets-v12/static/path-6+22c55e-0.9(${encodeURIComponent(routeGeometry)}),pin-s-a+22c55e(${fromCoords[0]},${fromCoords[1]}),pin-s-b+ef4444(${toCoords[0]},${toCoords[1]})/auto/800x300@2x?padding=60,40,60,40&access_token=pk.eyJ1IjoibWF4d2VzdDUyNSIsImEiOiJjbWtuZTY0cTgwcGIzM2VweTN2MTgzeHc3In0.nlM6XCog7Y0nrPt-5v-E2g`}
                              alt="Route line"
                              className="tru-analyze-popup-img tru-analyze-route-line-reveal"
                              style={{ 
                          ...
                          <div 
                            ...
                            style={{ left: `${Math.max(5, Math.min(95, routeProgress))}%` }}
                          >
                            <Truck className="w-4 h-4" />
                          </div>
                        </>
